    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                ...
                'value' => Html::a($model->createdBy->username, ['/user/view', 'id' => $model->created_by]),
                'format' => 'html',
                'visible' => !empty($model->created_by),
            ],
            [
                'attribute' => 'updated_by',
                'value' => Html::a($model->updatedBy->username, ['/user/view', 'id' => $model->updated_by]),
                'format' => 'html',
                'visible' => !empty($model->updated_by),
            ],
            'created_at:datetime',
            'updated_at:datetime',
        ],
